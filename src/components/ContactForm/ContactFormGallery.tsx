...
export const ContactFormGallery: React.FC<{}> = () => (
  <CardGallery css={{ alignItems: 'flex-start' }}>
    <ContactFormCard title="Contact Us" color={BLUE}>
      ...
      <input type="email" name="email" placeholder="Email Address" autoComplete="email" required={true} />
      <textarea name="message" placeholder="Type your Message" rows={5} />
    </ContactFormCard>

    <ContactFormCard title="New Members" color={YELLOW}>
      <input type="text" name="student_name" placeholder="Student Name" required={true} />
      <input type="email" name="student_email" placeholder="Student Email Address" required={true} />
      <input type="text" name="parent_name" placeholder="Parent/Guardian Name" required={true} />
      <input type="email" name="parent_email" placeholder="Parent/Guardian Email Address" required={true} />
      <input type="text" name="grade" placeholder="Grade for Fall School Year" />
